...
LOCALES = {
    "sala_maxx":   {"nombre":"Sala Maxx",       "tipo":"externo", "db_rec":"bs2026",        "db_bar":"barrabs2026",   "num_barras":5},
    "sala_kixx":   {"nombre":"Sala Kixx",        "tipo":"externo", "db_rec":"kixx2026",      "db_bar":"barrakixx2026", "num_barras":2},
    "luna_azul":   {"nombre":"Luna Azul",        "tipo":"externo", "db_rec":"lunaxilxes2026","db_bar":"barraluna2026", "num_barras":1},
...
def calcular_dia_externo(conn, db_rec, db_bar, num_barras, lote, fecha, anyo):
    cur = conn.cursor()
...
def get_totales_rango(local_key, anyo, fecha_ini, fecha_fin, incluir_dias=False):
    ...
    try:
        ...
        for lote, fecha in lotes:
            if cfg["tipo"] == "externo":
                d = calcular_dia_externo(conn, db_rec, db_bar, cfg["num_barras"], lote, fecha, anyo)
            else:
